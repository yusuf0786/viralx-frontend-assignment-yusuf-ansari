    ...
    variants: {
      variant: {
        ...
        primary:
          "bg-primary text-primary-foreground cursor-pointer shadow-xs hover:bg-primary/90",
        destructive:
          "bg-destructive text-destructive-foreground cursor-pointer shadow-xs hover:bg-destructive/90",
        outline:
          "border border-input bg-transparent cursor-pointer shadow-xs hover:bg-accent hover:text-accent-foreground",
